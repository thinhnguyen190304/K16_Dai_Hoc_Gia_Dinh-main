...
public class CustomerController {
    private List<String> countries = Arrays.asList("USA", "Canada", "United Kingdom", "Australia", "Germany", "India", "Việt Nam");
    ...
    public String customerFormDelete(@RequestParam("id9") int id, Model model) {
